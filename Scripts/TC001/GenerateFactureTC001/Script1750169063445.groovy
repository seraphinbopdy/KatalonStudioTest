...
import test_TC001_TC002_TC003.BuildDataGenerativeInvoice

Map requestDataAGenerateInvoice = BuildDataGenerativeInvoice.buildGenerateInvoiceData()

TestObject testObject = ObjectRepository.findTestObject('API/TC001/GenerateInvoiceTC001',requestDataAGenerateInvoice)
...
try {
	...
	if (invoiceId == null || invoiceId.toString().trim().isEmpty()) {
		...
		String dynamicLink = "${GlobalVariable.BASE_URL_INVOICE}/opencell/frontend/DEMO/portal/B2B/invoices/${invoiceId}/modify"
